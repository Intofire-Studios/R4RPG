...
def saveCheck(pathsave, path):
    ...
    try:
        ...
        create_inventory_table = """
            ALTER TABLE inventory ADD COLUMN pickaxe INTEGER "0"
            """
        execute_query(sqlite_connection, create_inventory_table)
    ...
    try:
        ...
        create_inventory_table = """
            ALTER TABLE inventory ADD COLUMN max_pickaxe INTEGER "0"
            """
        execute_query(sqlite_connection, create_inventory_table)
    ...
    try:
        ...
        create_inventory_table = """
            ALTER TABLE inventory ADD COLUMN stone INTEGER "0"
            """
        execute_query(sqlite_connection, create_inventory_table)
    ...
    try:
        ...
        create_inventory_table = """
            ALTER TABLE inventory ADD COLUMN copper INTEGER "0"
            """
        execute_query(sqlite_connection, create_inventory_table)
    ...
    try:
        ...
        create_inventory_table = """
            ALTER TABLE inventory ADD COLUMN tin INTEGER "0"
            """
        execute_query(sqlite_connection, create_inventory_table)
    ...
    try:
        ...
        create_inventory_table = """
            ALTER TABLE inventory ADD COLUMN iron INTEGER "0"
            """
        execute_query(sqlite_connection, create_inventory_table)
    ...
    try:
        ...
        create_inventory_table = """
            ALTER TABLE inventory ADD COLUMN aluminum INTEGER "0"
            """
        execute_query(sqlite_connection, create_inventory_table)
    ...
    try:
        ...
        create_inventory_table = """
            ALTER TABLE inventory ADD COLUMN silver INTEGER "0"
            """
        execute_query(sqlite_connection, create_inventory_table)
    ...
    try:
        ...
        create_inventory_table = """
            ALTER TABLE inventory ADD COLUMN topaz INTEGER "0"
            """
        execute_query(sqlite_connection, create_inventory_table)
    ...
    try:
        ...
        create_inventory_table = """
            ALTER TABLE inventory ADD COLUMN gold INTEGER "0"
            """
        execute_query(sqlite_connection, create_inventory_table)
    ...
    try:
        ...
        create_inventory_table = """
            ALTER TABLE inventory ADD COLUMN crystal INTEGER "0"
            """
        execute_query(sqlite_connection, create_inventory_table)
    ...
    try:
        ...
        create_inventory_table = """
            ALTER TABLE inventory ADD COLUMN diamond INTEGER "0"
            """
        execute_query(sqlite_connection, create_inventory_table)
    ...
    try:
        ...
        create_inventory_table = """
            ALTER TABLE inventory ADD COLUMN emerald INTEGER "0"
            """
        execute_query(sqlite_connection, create_inventory_table)
    ...
    try:
        ...
        create_inventory_table = """
            ALTER TABLE inventory ADD COLUMN ruby INTEGER "0"
            """
        execute_query(sqlite_connection, create_inventory_table)

    try:
        cursor.execute("SELECT sword FROM inventory;")
    except OperationalError:
        create_inventory_table = """
            ALTER TABLE inventory ADD COLUMN sword INTEGER "0"
            """
        execute_query(sqlite_connection, create_inventory_table)
    
    try:
        cursor.execute("SELECT max_sword FROM inventory;")
    except OperationalError:
        create_inventory_table = """
            ALTER TABLE inventory ADD COLUMN max_sword INTEGER "0"
            """
        execute_query(sqlite_connection, create_inventory_table)
 
    try:
        cursor.execute("SELECT damage FROM inventory;")
    except OperationalError:
        create_inventory_table = """
            ALTER TABLE inventory ADD COLUMN damage INTEGER "0"
            """
        execute_query(sqlite_connection, create_inventory_table)
 
    try:
        cursor.execute("SELECT armor FROM inventory;")
    except OperationalError:
        create_inventory_table = """
            ALTER TABLE inventory ADD COLUMN armor INTEGER "0"
            """
        execute_query(sqlite_connection, create_inventory_table)

    try:
        cursor.execute("SELECT max_armor FROM inventory;")
    except OperationalError:
        create_inventory_table = """
            ALTER TABLE inventory ADD COLUMN max_armor INTEGER "0"
            """
        execute_query(sqlite_connection, create_inventory_table)
